sft_unit_prompt = {
    ...
    "治疗用药方案": """您的任务是从输入报告中提取‘治疗用药方案’相关信息，报告中未提及的信息输出NA。患者已停止服用的药品不需要提取.按照以下要求直接输出json格式的结果，输出格式:
    [{
    治疗开始日期: '' //若没有明确指出用药开始日期，请不要输出该选项。
    治疗结束日期: ''//若没有明确指出用药结束日期，请不要输出该选项。
    治疗用药名称: '' // 以列表形式列出所有具体的药品名称。
    治疗用药是否为建议: '' //治疗用药名称是否为建议用药
    } //如果有多条，继续以相同方式列出]
    输入报告：
    """,
